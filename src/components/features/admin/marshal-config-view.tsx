    ...
    <div className="space-y-4">
      <Card className={isConfigured ? "border-emerald-200 bg-emerald-50/30" : "border-blue-200 bg-blue-50/30"}>
        ...
        <CardContent className="space-y-4 p-4 pt-0 sm:p-6 sm:pt-0">
          {isConfigured ? <p className="text-sm text-slate-600">Posten, Sollwerte, Bereiche und Schichten sind für <strong>{currentEvent.name}</strong> eingerichtet. Einteilungen bleiben immer ausschließlich bei diesem Event.</p> : <>
            <p className="text-sm text-slate-700">Übernimm die Struktur und Sollbesetzung aus einem früheren Event. Alle Posten starten anschließend unbesetzt bei <strong>0 / Soll</strong>; Helfer, Zusagen und Notizen werden nicht kopiert.</p>

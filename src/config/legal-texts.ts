...
const privacyDocEn: LegalDoc = {
  ...
  sections: [
    ...
    { title: "3. Processed data", paragraphs: ["Depending on the process step, we process in particular:"], bullets: ["first and last name", "date of birth", "address", "nationality", "e-mail address", "phone number", "emergency contact details", "vehicle, class and entry details", "event-related declarations and confirmations", "legal guardian details for minors", "status and process data for verification, check-in, technical inspection, payment and documents", "consent evidence such as consent version, text hash, locale, source and capture timestamp", "upload and document metadata for vehicle images and generated PDFs", "communication and delivery data from e-mail outbox and delivery records", "audit and operational data required for secure and traceable operation of the application"] },

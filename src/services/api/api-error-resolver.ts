...
const apiErrorMessages: Record<ApiErrorLocale, Partial<Record<string, string>>> = {
  de: {
    ...
    CLASS_REGISTRATION_CLOSED: "Diese Klasse ist geschlossen. Weitere Nennungen sind nicht möglich.",
  ...
  en: {
    ...
    CLASS_REGISTRATION_CLOSED: "This class is closed. Further entries are not possible.",
  ...
  cz: {
    ...
    CLASS_REGISTRATION_CLOSED: "Tato třída je uzavřena. Další přihlášky nejsou možné.",
  ...
  pl: {
    ...
    CLASS_REGISTRATION_CLOSED: "Ta klasa jest zamknięta. Dalsze zgłoszenia nie są możliwe.",

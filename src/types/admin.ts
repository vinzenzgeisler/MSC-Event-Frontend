...
export type AdminEntryMailDeliveryDto = {
  id: Id;
  status: string | null;
...
export type AdminEntryMailContentDto = {
  subjectRendered: string;
  bodyTextRendered: string;
  bodyHtmlRendered: string;
  htmlDocument: string;
...
export type AdminEntryMailHistoryItemDto = {
  id: Id;
  eventId?: Id | null;
  toEmail: string;
  subject: string;
  ...
  createdAt: string;
  updatedAt: string;
  relation: "entry" | "registration_group" | "unknown";
  delivery: AdminEntryMailDeliveryDto | null;
  content: AdminEntryMailContentDto;
  templateData?: Record<string, unknown>;
};

export type AdminEntryMailHistoryItem = {
  id: Id;
  recipient: string;
  subject: string;
  subjectRendered: string;

...
const baseMessages = {
  de: {
    ...
    start: {
      ...
      saveAndContinue: "Hinzufügen und weiter",
      classLabel: "Klasse",
      ...
      saveBeforeContinue: "Bitte füge die aktuelle Startmeldung zuerst hinzu oder korrigiere die markierten Felder.",
  ...
  en: {
    ...
    start: {
      ...
      saveBeforeContinue: "Please add the current start entry first or fix the highlighted fields.",
  ...
  cz: {
    ...
    start: {
      ...
      saveAndContinue: "Přidat a pokračovat",
      classLabel: "Třída",
      ...
      saveBeforeContinue: "Nejprve přidejte aktuální start nebo opravte zvýrazněná pole.",
...
const messages: Record<AnmeldungLocale, AnmeldungMessages> = {
  ...
  pl: {
    ...
    start: {
      ...
      saveAndContinue: "Dodaj i przejdź dalej",
      classLabel: "Klasa",
      ...
      saveBeforeContinue: "Najpierw dodaj bieżące zgłoszenie albo popraw zaznaczone pola.",

...
const messages = {
  de: {
    ...
    driver: {
      ...
      nationalityPlaceholder: "Land suchen und auswählen",
      ...
      emergencyPhonePlaceholder: "+49 170 123 4567",
    ...
    start: {
      ...
      codriverPhonePlaceholder: "+49 170 123 4567",
  ...
  en: {
    ...
    driver: {
      ...
      nationalityPlaceholder: "Search and select a country",
  ...
  cz: {
    ...
    driver: {
      ...
      nationalityPlaceholder: "Vyhledejte a vyberte zemi",
